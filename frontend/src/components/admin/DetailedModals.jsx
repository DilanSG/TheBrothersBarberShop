...
export const DetailedSalesModal = ({ isOpen, onClose, salesData, barberName, dateRange, loading, error }) => {
  ...
  React.useEffect(() => {
    if (salesData) {
      console.log('🔍 MODAL DEBUG - salesData recibida:', salesData);
      console.log('🔍 MODAL DEBUG - primer día:', salesData[0]);
      console.log('🔍 MODAL DEBUG - estructura esperada vs real:', {
  ...
  console.log('🔍 MODAL TOTALES CALCULADOS:', {
    totalAmount,
    totalProducts,
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-gray-400">
                                ...
                                {sale.type === 'walkIn' && <span className="ml-1 text-blue-300">(Servicio)</span>}
                              </p>
                            </div>
                          </div>
                          <div className="text-right">
...
export const DetailedAppointmentsModal = ({ isOpen, onClose, appointmentsData, barberName, dateRange, loading, error }) => {
  ...
  React.useEffect(() => {
    if (appointmentsData) {
      console.log('🔍 MODAL CITAS DEBUG - appointmentsData recibida:', appointmentsData);
      console.log('🔍 MODAL CITAS DEBUG - primer día:', appointmentsData[0]);
      console.log('🔍 MODAL CITAS DEBUG - estructura esperada vs real:', {
  ...
  console.log('🔍 MODAL CITAS TOTALES CALCULADOS:', {
    totalAppointments,
    totalRevenue,
