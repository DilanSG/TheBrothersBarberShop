...
export const useDetailedReports = () => {
  ...
  const fetchDetailedSales = useCallback(async (barberId, startDate, endDate, useCache = true) => {
    ...
    try {
      console.log('🛒 Obteniendo reporte detallado de ventas:', { barberId, startDate, endDate });
      ...
      console.log('✅ Reporte detallado de ventas obtenido:', data);
      return data;
  ...
  const fetchWalkInDetails = useCallback(async (barberId, startDate, endDate, useCache = true) => {
    ...
    try {
      console.log('✂️ Obteniendo detalles de cortes walk-in:', { barberId, startDate, endDate });
      ...
      console.log('✅ Detalles de cortes walk-in obtenidos:', data);
      return data;
  ...
  const fetchDetailedCuts = useCallback(async (barberId, startDate, endDate, useCache = true) => {
    ...
    try {
      console.log('✂️ Obteniendo reporte detallado de cortes:', { barberId, startDate, endDate });
      ...
      console.log('✅ Reporte detallado de cortes obtenido:', data);
      return data;
  ...
  const fetchCompletedAppointments = useCallback(async (barberId, startDate, endDate, useCache = true) => {
    ...
    try {
      console.log('📅 Obteniendo detalles de citas completadas:', { barberId, startDate, endDate });
      ...
      console.log('✅ Detalles de citas completadas obtenidos:', data);
      return data;
